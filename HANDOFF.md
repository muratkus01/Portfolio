...
* **Interactive Showcase Dashboard:** Built standalone recruiter-ready dashboard `showcase.html` with dark glassmorphic UI, project category filters, interactive modal lightbox for all 6 benchmark plots, live simulator sandbox (P04 REC network charge break-even, P03 §14a dimming, P05 hybrid curtailment), and wired into `python showcase.py --html`.
