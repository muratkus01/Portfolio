...
* **Expanded Multi-Project 24h Dispatch Canvases (380px Height):** Interactive discrete dispatch engine with dual Y-axes expanded across all 6 projects in `showcase.html`. Features 36 calibrated seasonal and extreme market dynamic regimes, live telemetry scrubbers, discrete clickable legend cards, and bespoke physics overlays (bidirectional zero-centered flow for P02, §14a dimming ceiling for P03, P2P peer trade area for P04, over-planting curtailment shading for P05, and probabilistic quantile fan ribbons for P06).
